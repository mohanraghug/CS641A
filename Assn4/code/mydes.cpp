...
int main()
{
    ...
    b64 plain_text = 0x02468aceeca86420;
    b64 key = 0x0f1571c947d9e859;

    b64 LR = apply_ip(plain_text);
    ...
    int _R = 16;
    cout << setw(8) << setfill('0') << hex << L.to_ullong() << ' ' << R.to_ullong() << endl;
    for (int r = 0; r < _R; r++)
    {
        cout << dec << r + 1 << " ";
        print(keys[r]);
